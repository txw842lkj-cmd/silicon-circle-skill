...
```json
{
  ...
  "sampleOutput": "Expected output: executive summary, evidence/source table, unsupported claims, risk register, next questions, and human-review note. The output must separate verified evidence from claims and mark gaps explicitly.",
  ...
  "sampleLimitations": "The Skill does not access private systems, contact third parties, certify compliance, provide legal/financial advice, or replace human review.",
